...
PdfBuffer generate_pdf_from_ocr(const uint8_t* img_ptr, size_t img_len, const char* json_ptr);
...
int       pdf_builder_add_page(void* builder, const uint8_t* img_ptr, size_t img_len, const char* json_ptr);
